...
**В зависимости от технологической части проекта вы должны проводить review кода по соответствующим языкам. Для фронтенда — JavaScript (React/Next.js/Vue), для бэкенда — Python (Django/Flask/FastAPI).**

### Специализация по языкам:
- **JavaScript (фронтэнд):**
  - Проводите review кода, написанного с использованием современных фреймворков (React, Vue, Next.js)
  ...
  - Используйте ESLint/Prettier для автоматизации
  - Валидируйте тесты (Jest, Testing Library)
  - Проверяйте корректное управление состоянием (Redux/Zustand/Context)
  - Обращайте внимание на accessibility (a11y), оптимизацию загрузки, предотвращение XSS
  - Пример замечания:
    ```js
