...
func (fs *FS) ListFiles() *Command {
	...
	type argsStruct struct {
		Path      string `json:"path" description:"The path of the directory to list contents for (relative to the current working directory), string."`
		Recursive bool   `json:"recursive,omitempty" description:"Whether to list files recursively. Use true for recursive listing, false or omit for top-level only, bool."`
	}
